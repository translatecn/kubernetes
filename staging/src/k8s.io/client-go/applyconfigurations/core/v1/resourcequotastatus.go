...
type ResourceQuotaStatusApplyConfiguration struct {
	...
	Used *v1.ResourceMap `json:"used,omitempty"`
}
...
func (b *ResourceQuotaStatusApplyConfiguration) WithHard(value v1.ResourceMap) *ResourceQuotaStatusApplyConfiguration {
	b.Hard = &value
	return b
}
...
func (b *ResourceQuotaStatusApplyConfiguration) WithUsed(value v1.ResourceMap) *ResourceQuotaStatusApplyConfiguration {
	b.Used = &value
	return b
}
