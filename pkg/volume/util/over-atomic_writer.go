...
func (w *AtomicWriter) Write(payload map[string]FileProjection) error {
	...
	// (2)
	// drwxrwxrwx 3 root root 4096 May 28 22:30 ./
	// drwxr-xr-x 3 root root 4096 May 28 22:30 ../
	// drwxr-xr-x 2 root root 4096 May 28 22:30 ..2023_05_28_14_30_57.2172353647/
	// lrwxrwxrwx 1 root root   32 May 28 22:30 ..data -> ..2023_05_28_14_30_57.2172353647/
	// lrwxrwxrwx 1 root root   27 May 28 22:30 tigera-ca-bundle.crt -> ..data/tigera-ca-bundle.crt
