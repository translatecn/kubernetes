...
func MarkFSResizeFinished(pvc *v1.PersistentVolumeClaim, newSize resource.Quantity, kubeClient clientset.Interface) (*v1.PersistentVolumeClaim, error) {
	newPVC := pvc.DeepCopy()
...
// MergeResizeConditionOnPVC 更新 PVC 的请求调整条件,同时保留其他条件不变.
