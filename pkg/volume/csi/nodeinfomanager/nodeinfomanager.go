...
type Interface interface {
	...
	// InitializeCSINodeWithAnnotation 更新或创建带有 CSI Migration 注释的CSINode对象
...
// Node ID information.
func updateNodeIDInNode(csiDriverName string, csiDriverNodeID string) nodeUpdateFunc {
...
func (nim *nodeInfoManager) updateCSINode(driverName string, driverNodeID string, maxAttachLimit int64, topology map[string]string) error {
...
func (nim *nodeInfoManager) tryUpdateCSINode(csiKubeClient clientset.Interface, driverName string, driverNodeID string, maxAttachLimit int64, topology map[string]string) error {
...
func (nim *nodeInfoManager) installDriverToCSINode(nodeInfo *storagev1.CSINode, driverName string, driverNodeID string, maxAttachLimit int64, topology map[string]string) error {
...
func (nim *nodeInfoManager) uninstallDriverFromCSINode(csiDriverName string) error {
