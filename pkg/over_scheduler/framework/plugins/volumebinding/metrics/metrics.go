...
// VolumeSchedulerSubsystem - subsystem name used by over_scheduler
...
// RegisterVolumeSchedulingMetrics is used for over_scheduler, because the volume binding cache is a library
// used by over_scheduler process.
