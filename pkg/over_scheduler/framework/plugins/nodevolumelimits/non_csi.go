...
import (
	...
	"k8s.io/kubernetes/pkg/over_scheduler/framework/plugins/feature"
...
const AzureDiskName = over_names.AzureDiskLimits

// NewAzureDisk returns function that initializes a new plugin and returns it.
func NewAzureDisk(_ runtime.Object, handle framework.Handle, fts over_feature.Features) (framework.Plugin, error) {
...
const CinderName = over_names.CinderLimits

// NewCinder returns function that initializes a new plugin and returns it.
func NewCinder(_ runtime.Object, handle framework.Handle, fts over_feature.Features) (framework.Plugin, error) {
	informerFactory := handle.SharedInformerFactory()
...
const EBSName = over_names.EBSLimits

// NewEBS returns function that initializes a new plugin and returns it.
func NewEBS(_ runtime.Object, handle framework.Handle, fts over_feature.Features) (framework.Plugin, error) {
	informerFactory := handle.SharedInformerFactory()
...
const GCEPDName = over_names.GCEPDLimits

// NewGCEPD returns function that initializes a new plugin and returns it.
func NewGCEPD(_ runtime.Object, handle framework.Handle, fts over_feature.Features) (framework.Plugin, error) {
	informerFactory := handle.SharedInformerFactory()
