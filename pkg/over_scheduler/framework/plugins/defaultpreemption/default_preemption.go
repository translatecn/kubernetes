...
import (
	...
	"k8s.io/kubernetes/pkg/over_scheduler/framework/preemption"
	"k8s.io/kubernetes/pkg/over_scheduler/util"
)

// Name of the plugin used in the plugin registry and configurations.
const Name = over_names.DefaultPreemption
...
func New(dpArgs runtime.Object, fh framework.Handle, fts over_feature.Features) (framework.Plugin, error) {
...
func (pl *DefaultPreemption) PostFilter(ctx context.Context, state *framework.CycleState, pod *v1.Pod, m framework.NodeToStatusMap) (*framework.PostFilterResult, *framework.Status) {
	...
	pe := preemption.Evaluator{
		PluginName: over_names.DefaultPreemption,
		Handler:    pl.fh,
