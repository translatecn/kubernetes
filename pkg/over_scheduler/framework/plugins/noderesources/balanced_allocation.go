...
const BalancedAllocationName = over_names.NodeResourcesBalancedAllocation
...
func NewBalancedAllocation(baArgs runtime.Object, h framework.Handle, fts over_feature.Features) (framework.Plugin, error) {
