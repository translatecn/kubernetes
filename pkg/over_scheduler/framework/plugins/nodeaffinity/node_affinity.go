...
const (
	...
	errReasonEnforced = "node(s) didn't match over_scheduler-enforced node affinity"
...
func (pl *NodeAffinity) NormalizeScore(ctx context.Context, state *framework.CycleState, pod *v1.Pod, scores framework.NodeScoreList) *framework.Status {
	return over_helper.DefaultNormalizeScore(framework.MaxNodeScore, false, scores)
}
