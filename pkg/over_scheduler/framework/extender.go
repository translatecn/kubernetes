...
type Extender interface {
	...
	// the scores computed by Kubernetes over_scheduler. The total scores are used to do the host selection.
	...
	// SupportsPreemption returns if the over_scheduler extender support preemption or not.
	SupportsPreemption() bool

	// IsIgnorable returns true indicates scheduling should not fail when this extender
	// is unavailable. This gives over_scheduler ability to fail fast and tolerate non-critical extenders as well.
	IsIgnorable() bool
}
