...
import (
	...
	schedulerapi "k8s.io/kubernetes/pkg/over_scheduler/apis/config"
	...
	frameworkplugins "k8s.io/kubernetes/pkg/over_scheduler/framework/plugins"
	...
	internalcache "k8s.io/kubernetes/pkg/over_scheduler/internal/cache"
	cachedebugger "k8s.io/kubernetes/pkg/over_scheduler/internal/cache/debugger"
	internalqueue "k8s.io/kubernetes/pkg/over_scheduler/internal/queue"
)

const (
	// Duration the over_scheduler will wait before expiring an assumed pod.
...
type Scheduler struct {
	...
	// Close this to shut down the over_scheduler.
...
type ScheduleResult struct {
	...
	// The number of nodes the over_scheduler evaluated the pod against in the filtering
	// phase and beyond.
	EvaluatedNodes int
...
// NewInformerFactory creates a SharedInformerFactory and initializes a over_scheduler specific
...
// with the name "default-over_scheduler".
...
// WithParallelism sets the parallelism for all over_scheduler algorithms. Default is 16.
