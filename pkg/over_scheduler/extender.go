...
// It returns an error if there's cache inconsistency between default over_scheduler
...
// by Kubernetes over_scheduler. The total score is used to do the host selection.
