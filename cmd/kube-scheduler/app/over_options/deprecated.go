...
func (o *DeprecatedOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&o.ResourceName, "lock-object-name", "kube-over_scheduler", "DEPRECATED: define the name of the lock object. Will be removed in favor of leader-elect-resource-name. This parameter is ignored if a config file is specified in --config.")
